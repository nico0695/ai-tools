...
Primero el paquete, desde [ai-tools](https://github.com/nico0695/ai-tools): `./install.sh harness --project ~/tu-app` (deja `./sdd-lite/` en el proyecto). Después, en el agente:

> "Install sdd-lite in this repo and configure it for Claude Code"

Eso ejecuta `sddl-init`: escanea el proyecto, detecta stack y AI, instala skills y genera los archivos base en `./sdd-lite/`.
