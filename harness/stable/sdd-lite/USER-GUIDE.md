...
Install the package with `./install.sh harness` from [ai-tools](https://github.com/nico0695/ai-tools) (copies `./sdd-lite/` into the project). `sddl-init` is the bootstrap skill: run it the first time, or when the bootstrap becomes stale.
