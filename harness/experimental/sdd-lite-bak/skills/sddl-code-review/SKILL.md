...
- the orchestrator loads `orchestrator/modules/review-runtime.md`, freezes the target, triages it, and launches each lens as a fresh read-only worker using its Review Worker Envelope
...
- `skills/_shared/sddl-review-ledger-contract.md` (ledger rules shared with judgment-day)
...
Use `templates/artifacts/review-ledger.md` as the baseline shape.
